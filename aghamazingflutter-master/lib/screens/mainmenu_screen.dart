...
import 'content_screen.dart';  // Added import for ContentScreen
                          ...
                          children: [
                            ...
                            Consumer<SessionService>(
                              builder: (context, s, _) => IconStatButton(
                                assetPath: asset('bubble_power').isNotEmpty ? asset('bubble_power') : 'assets/images/default_power.png',  // Default asset if not specified
                                width: topIconW,
                                height: topIconH,
                            ...
                            Consumer<SessionService>(
                              builder: (context, s, _) => IconStatButton(
                                assetPath: asset('gems').isNotEmpty ? asset('gems') : 'assets/images/default_gems.png',  // Default asset if not specified
                                width: topIconW,
                                height: topIconH,
                            ...
                            Consumer<SessionService>(
                              builder: (context, s, _) => _EnergyDisplay(
                                assetPath: asset('energy').isNotEmpty ? asset('energy') : 'assets/images/default_energy.png',  // Default asset if not specified
                                width: topIconW,
                                height: topIconH,
                            ...
                            children: [
                              ...
                              Positioned(
                                ...
                                child: ImageAssetButton(
                                  assetPath: asset('btn_arscan').isNotEmpty ? asset('btn_arscan') : 'assets/images/buttons/btn_arscan_default.png',  // Default asset if not specified
                                  width: scanW,
                                  height: scanH,
                                  fill: true,
                              ...
                              Positioned(
                                ...
                                child: Row(
                                  children: [
                                    ImageAssetButton(
                                      assetPath: asset('btn_profile').isNotEmpty ? asset('btn_profile') : 'assets/images/buttons/btn_profile_default.png',  // Default asset if not specified
                                      width: profileW,
                                      height: profileH,
                                      fill: true,
                                      onTap: () => Navigator.of(context).push(
                                    ...
                                    ImageAssetButton(
                                      assetPath: asset('btn_chatbot').isNotEmpty ? asset('btn_chatbot') : 'assets/images/buttons/btn_chatbot_default.png',  // Default asset if not specified
                                      width: chatW,
                                      height: chatH,
                                      fill: true,
                                      onTap: () => Navigator.of(context).push(
                                    ...
                                    ImageAssetButton(
                                      assetPath: asset('btn_content').isNotEmpty ? asset('btn_content') : 'assets/images/buttons/btn_content.png', // Default asset if not specified
                                      width: chatW,
                                      height: chatH,
                                      fill: true,
                                      onTap: () => Navigator.of(context).push(
                              ...
                              Positioned(
                                ...
                                child: ImageAssetButton(
                                  assetPath: asset('btn_select').isNotEmpty ? asset('btn_select') : 'assets/images/buttons/btn_select_default.png',  // Default asset if not specified
                                  width: selectW,
                                  height: selectH,
                                  fill: true,
                                  onTap: () => showStyledSnackBar(
                          ...
                          child: ConstrainedBox(
                            ...
                            child: AspectRatio(
                              ...
                              child: asset('btn_gem_grab').isNotEmpty
                                  ? ImageAssetButton(
                                assetPath: asset('btn_gem_grab').isNotEmpty ? asset('btn_gem_grab') : 'assets/images/buttons/btn_gem_grab_default.png',  // Default asset if not specified
                                width: double.infinity,
