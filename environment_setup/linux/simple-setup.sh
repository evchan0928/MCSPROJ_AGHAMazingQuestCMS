...
# Simplified setup script for AGHAMazingQuestCMS on Ubuntu Linux
# This script works with available Python version
...
if [ ! -d "./venv" ]; then
    echo "Creating virtual environment with available Python..."
    python3 -m venv venv
fi
...
echo "  cd /home/master/Documents/PBL/MCSPROJ_AGHAMazingQuestCMS"
echo "  python manage.py runserver"
echo ""
echo "To start the React frontend (in a separate terminal):"
echo "  cd /home/master/Documents/PBL/MCSPROJ_AGHAMazingQuestCMS/frontend"
echo "  npm start"
echo ""
