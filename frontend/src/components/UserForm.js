...
export default function UserForm({ user: initial, roles = [], onCancel, onSaved }) {
  ...
  useEffect(() => { setUser(initial || { username: '', email: '', first_name: '', last_name: '', is_active: true, is_staff: false, is_superuser: false, roles: [], password: '' }); }, [initial]);
